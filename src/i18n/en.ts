...
const en: Translations = {
  ...
  materials: {
    ...
    intro: 'Ready-made copy, screenshots and brand guidelines for presenting pargihaldur — in decks, print and social media.',
    unlistedNote: 'This page is meant for park operators and partners and is not visible to search engines. Share the link directly only.',
    backToSite: '← pargihaldur.ee',
    brandSection: 'Brand.',
    brandNameNote: 'The name is always written in lowercase: "pargihaldur". As a logo, set the name in monospace (JetBrains Mono).',
    brandColorsLabel: 'COLORS',
    brandColorDark: 'Primary',
    brandColorLight: 'Background',
    textsSection: 'Ready-made copy.',
    textsHint: 'Copy and use as-is — it keeps the message consistent.',
    shortPitchLabel: 'SHORT PITCH',
    shortPitch: 'pargihaldur — operations software for caravan parks. Self-service bookings, automatic gate access and accounting in one system. pargihaldur.ee',
    longPitchLabel: 'LONG PITCH',
    longPitch: 'pargihaldur is operations software that lets a caravan park run itself. Guests book and pay from any device in under a minute; the confirmation, receipt and gate code land in their inbox automatically. The automatic gate opens from the guest\'s link with no front desk, and every open event is logged. Built-in accounting keeps every booking and payment traceable. AI editors help write the local guide, terms and pricing rules in plain language. Live with a real customer: willipu.pargihaldur.ee. Demo: contact@pargihaldur.ee or pargihaldur.ee',
    copy: 'Copy',
    copied: 'Copied ✓',
    ...
    imageCaptions: {
      ...
      admin: 'Admin panel',
      access: 'Gate access page',
      accessEmail: 'Access link email',
      aiSuggest: 'AI editor diff preview',
      sitemap: 'Interactive park map',
